...
## Monitoring: Hartford nomogram

![](images-aminoglycoside/nomogram.png){fig-align="center" width="700"}
...
![](images-aminoglycoside/AG_resistance mechanism.png){fig-align="center" width="800"}
...
::: aside
For enterococcal endocarditis, synergy testing is critical. High-level aminoglycoside resistance (HLAR) eliminates synergy. The gentamicin duration has been shortened to reduce nephrotoxicity. For staph, recent data questions the benefit (dual ß-lactam therapy preferred)
:::
